...
const AddressForm = () => {
  ...
  const handleSubmission = async (e) => {
    ...
    if( !name || !locality || !address || !city || !state || !landmark || !addressType || !pincode){
  ...
  return (
    <div className="h-screen w-screen py-2">
      <h1 className="font-semibold text-lg p-2 text-blue-500">
        Delivery Address
      </h1>
      <form
        // onSubmit={(e) => handleSubmission(e)}
        className="max-h-max w-full p-4 flex flex-col gap-2"
      >
        ...
        <input
          ...
          type="text"
          placeholder="Name"
          className="h-12 w-full px-2 border-2 border-gray-300 rounded outline-blue-500"
        />
