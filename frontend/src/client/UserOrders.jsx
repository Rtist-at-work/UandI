                    ...
                    order.status.toLowerCase() !== "cancelled" ? (
                      ...
                      <div className="md:flex flex-col justify-center gap-2 hidden   mx-autolg:w-[70%] md:w-[60%]  relative">
                        <div className="flex justify-center items-center gap-2">
                          ...
                          >
                            {order.status} on delievery date
                          </p>
                        </div>
                        <p className="text-gray-500 text-sm mx-auto">Item has been deleivered delivery date</p>
                        <p className="text-sm text-blue-500 flex items-center gap-2 mx-auto hover:text-green-500"><FaStar className="xsm:h-6 xsm:w-6 md:h-2 xsm:w-2 text-blue-500 hover:text-green-500" /> Rate & Review Product</p>
                      </div>
                    )}
